...
export const INITIAL_MINERS: MinerProfile[] = [
    ...
    { name: "Antminer S21 Pro (225T)", hashrateTH: 225, powerWatts: 3375, price: 0 },
    { name: "Antminer S21 Pro (235T)", hashrateTH: 235, powerWatts: 3525, price: 0 },
    { name: "Antminer S21e XP Hydro", hashrateTH: 470, powerWatts: 5640, price: 0 }, // Est
    // Future / Pre-order
    { name: "Antminer S23 Hydro", hashrateTH: 500, powerWatts: 6500, price: 0 }, // Placeholder/Estimate
    { name: "Antminer S23", hashrateTH: 300, powerWatts: 4500, price: 0 }, // Placeholder
    // Altcoins
