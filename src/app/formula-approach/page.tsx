...
import { Loader2, RefreshCw, Calculator, FileText } from "lucide-react";
...
export default function FormulaApproachPage() {
    // State
    ...
    const calculate = () => {
        ...
        setTimeout(() => {
            ...
            const contract: ContractTerms = {
                ...
                opexRate: 0,
                poolFee: 0, // Formula assumes revenue is gross? Or user didn't specify pool fee in prompt. 
                // Prompt says "r0_btc = (hashrate_th / network_hash_th) * 144 * 3.125". 
                // This implies NO pool fee.
                contractDurationYears: 10 // Cap at 10 years for safety
            };
